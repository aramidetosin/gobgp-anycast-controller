#!/bin/sh
# service-node-dns-ntp: first-boot L2/L3 bootstrap = the real host's netplan 01-fabric.yaml, as a script.
...
ip route replace default via 10.167.30.1 dev bond0 metric 50
