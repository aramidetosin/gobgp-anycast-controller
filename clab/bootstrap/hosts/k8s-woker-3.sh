#!/bin/sh
# k8s-woker-3: first-boot L2/L3 bootstrap = the real host's netplan 01-fabric.yaml, as a script.
...
ip link set bond0 address 50:00:00:10:00:01
...
ip addr add 10.167.20.13/24 dev bond0
