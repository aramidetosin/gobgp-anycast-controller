#!/bin/sh
# dc2-k8s-worker-1: first-boot L2/L3 bootstrap = the real host's netplan 01-fabric.yaml, as a script.
...
ip link set bond0 address 50:00:00:20:00:01
...
ip addr add 10.168.10.21/24 dev bond0
